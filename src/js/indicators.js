...
export class MAIndicator extends Indicator {
    ...
    constructor() {
        ...
        let M3 = new exprs.ParameterExpr("M3", 2, 1000, 20);
...
export class TRENDIndicator extends Indicator {

    constructor() {
        super();
        let T1 = new exprs.ParameterExpr("T1", 0, 1000, 1);
        let T2  = new exprs.ParameterExpr("T2", 0, 1000, 1);
        this.addParameter(T1);
        this.addParameter(T2);
        this.addOutput(new exprs.RangeOutputExpr("TREND",
            new exprs.MaExpr(new exprs.CloseExpr(), T1)
        ));
        this.addOutput(new exprs.RangeOutputExpr("TREND",
            new exprs.MaExpr(new exprs.CloseExpr(), T2)
        ));
    }
