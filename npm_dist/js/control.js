...
var Control = exports.Control = function () {
    ...
    _createClass(Control, null, [{
        ...
        value: function onSize(w, h) {
            var width = w || window.screen.width;
            var chartWidth = width;
            var height = h || window.screen.height;
            ...
            mainCanvas.width = canvasGroupRect.w * 1;
            mainCanvas.height = canvasGroupRect.h * 1;
            overlayCanvas.width = canvasGroupRect.w * 1;
            overlayCanvas.height = canvasGroupRect.h * 1;
            mainCanvas.style.width = canvasGroupRect.w * 1;
            mainCanvas.style.height = canvasGroupRect.h * 1;
            overlayCanvas.style.width = canvasGroupRect.w * 1;
            overlayCanvas.style.height = canvasGroupRect.h * 1;
            if (tabBarShown) {
                tabBar.css({
        ...
        value: function mouseWheel(e, delta) {
            _chart_manager.ChartManager.instance.scale(e.originalEvent.wheelDelta > 0 ? 1 : -1);
            _chart_manager.ChartManager.instance.redraw("All", true);
            return false;
        }
    }, {
