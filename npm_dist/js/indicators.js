...
var MAIndicator = exports.MAIndicator = function (_Indicator2) {
    ...
    function MAIndicator() {
        ...
        var M1 = new exprs.ParameterExpr("M1", 2, 1000, 5);
        var M2 = new exprs.ParameterExpr("M2", 2, 1000, 10);
        var M3 = new exprs.ParameterExpr("M3", 2, 1000, 20);
        var M4 = new exprs.ParameterExpr("M4", 2, 1000, 60);
...
var TRENDIndicator = exports.TRENDIndicator = function (_Indicator21) {
    _inherits(TRENDIndicator, _Indicator21);

    function TRENDIndicator() {
        _classCallCheck(this, TRENDIndicator);

        var _this21 = _possibleConstructorReturn(this, (TRENDIndicator.__proto__ || Object.getPrototypeOf(TRENDIndicator)).call(this));

        var T1 = new exprs.ParameterExpr("T1", 0, 1000, 1);
        var T2 = new exprs.ParameterExpr("T2", 0, 1000, 1);
        _this21.addParameter(T1);
        _this21.addParameter(T2);
        _this21.addOutput(new exprs.RangeOutputExpr("TREND", new exprs.MaExpr(new exprs.CloseExpr(), T1)));
        _this21.addOutput(new exprs.RangeOutputExpr("TREND", new exprs.MaExpr(new exprs.CloseExpr(), T2)));
        return _this21;
    }
...
var STOCHRSIIndicator = exports.STOCHRSIIndicator = function (_Indicator22) {
    _inherits(STOCHRSIIndicator, _Indicator22);

    function STOCHRSIIndicator() {
        _classCallCheck(this, STOCHRSIIndicator);

        var _this22 = _possibleConstructorReturn(this, (STOCHRSIIndicator.__proto__ || Object.getPrototypeOf(STOCHRSIIndicator)).call(this));
        ...
        _this22.addOutput(new exprs.RangeOutputExpr("MA", new exprs.MaExpr(STOCHRSI, P2)));
        return _this22;
    }
