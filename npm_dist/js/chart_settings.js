...
var ChartSettings = exports.ChartSettings = function () {
    ...
    _createClass(ChartSettings, null, [{
        ...
        value: function init() {
            var _indic_param = {};
            var _name = ['MA', 'EMA', 'VOLUME', 'MACD', 'KDJ', 'StochRSI', 'RSI', 'DMI', 'OBV', 'BOLL', 'DMA', 'TRIX', 'BRAR', 'VR', 'EMV', 'WR', 'ROC', 'MTM', 'PSY', 'TREND'];
        ...
        value: function load() {
            ...
            var start = document.cookie.indexOf("chartSettingsJ=");
            if (start < 0) return;
            start += "chartSettingsJ=".length;
        ...
        value: function save() {
            ...
            document.cookie = "chartSettingsJ=" + escape(JSON.stringify(ChartSettings._data)) + ";expires=" + exdate.toGMTString();
        }
    }]);
